...
/**
   原地址：http://blog.csdn.net/fightforyourdream/article/details/16843303
 ...
 *
 */
public class BinaryTreeInverView {
...
//       System.out.println(isCompleteBinaryTreeRec(r1));
        ...
        //根據前序和後序重建二叉樹  例：[1,2,3,4,5,6,7],[3,2,4,1,6,5,7]
       /* List<Integer> preOrder = new ArrayList<>();
        preOrder.add(1);preOrder.add(2);preOrder.add(3);preOrder.add(4);preOrder.add(5);preOrder.add(6);preOrder.add(7);
        List<Integer> inOrder = new ArrayList<>();
        inOrder.add(3);inOrder.add(2);inOrder.add(4);inOrder.add(1);inOrder.add(6);inOrder.add(5);inOrder.add(7);
        TreeNode t = rebuildBinaryTreeRec(preOrder,inOrder);*/
        //TreeNode t = reConstructBinaryTree(new int[]{1,2,3,4,5,6,7},new int[]{3,2,4,1,6,5,7});
